...
**App Idea:** The LeafGuard Flutter App is designed to address the issue of identifying plant diseases, specifically leaf diseases, through a simple mobile application. The app utilizes a Deep Learning model based on the VGG-16 architecture to predict whether a leaf is infected with a disease or not. The goal is to assist farmers in quickly identifying infected areas in their plantations, enabling them to plan and implement mitigation strategies effectively.
...
<div style="display: flex; justify-content: space-between;">
   ...
   <img src="/Screenshot%20-%20Prediction0.jpeg" alt="Screenshot - Prediction" style="width: 220px; height: 490px;">
